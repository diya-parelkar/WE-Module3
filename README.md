...
### Assignment 05 - Diamonds Report
Technical report/essay on "developing strategies for the bidding card game 'Diamonds' with GenAI."

### Assignment 06 - Pokemon Game
A comparison report between SQL and NoSQL databases while creating a database for a Pokémon game that involves a classic many-to-many relationship.
